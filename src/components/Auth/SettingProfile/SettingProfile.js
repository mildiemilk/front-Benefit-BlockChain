                ...
                <Grid.Row columns={2}>
                    <Grid.Column width={3}>
                        <SegmentWithHeight raised>
                            ...
                            <Image centered src='http://www.cotto.com/common/data/series/b-man/03.jpg' size='small' shape='circular' />
                    ...
                    <Grid.Column width={5}>
                        <Segment raised>
                            ...
                            <Dropdown placeholder='ประเภทธุรกิจ' name='typeOfB' fluid selection options={BusinessTypes} />
                            <Detail3>
                            จำนวนพนักงาน
                            </Detail3>
                            <Dropdown placeholder='จำนวนพนักงาน' name='numberOfEmployees' fluid selection options={NumberOfEmployees} />
                            <Detail3>
