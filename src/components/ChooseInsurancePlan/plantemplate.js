...
import { ManagePlan, ImageIcon1, ImageIcon2, EmptyPlan, EmptyPlanText} from './styled'
...
class PlanTemplate extends Component{
      ...
      return(
        <td style={{width:'30px', paddingLeft:'40px'}} >
           <Icon
             ...
             onClick={() => this.props.handleDeleteChooseInsurance(this.props.index,colorPlan)}
             />
        </td>
      )
    }
  ...
  render(){
    ...
    if(this.props.closetap){
      ...
      if(this.props.colorPlan==1){
        return(
          <div onClick={() => this.props.handleDeleteOurplan(this.props.index)}
        ...
        return(
          <div onClick={() => this.props.handleDeleteSpacialPlan(this.props.index)}
            style={{cursor:'pointer'}}
             >
            <ManagePlan style={{backgroundColor:'#c0ccda'}}>
              {this.RenderTable(colorPlan,id)}
