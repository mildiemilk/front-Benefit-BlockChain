...
import {Detail,Head,Inner,Inner2,UploadBox,FileuploadBox,
        subInner,Submit,Submitupload,Inboxtext,BrowsButton,
        Imagestyle,DropzoneStyle,inputStyle,TextNormal } from './styled'
import {
  Grid,
  Image,
  Container,
