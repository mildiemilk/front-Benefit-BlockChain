...
import { DetailDiv, Text, Back, SettingList, DivInput, SettingLine, ButtonSetting, ButtonSettings } from './styled'
    ...
    render(){
        return(
            <DetailDiv>
                ...
                <SettingList>การคำนวณสวัสดิการสำหรับพนักงานได้เลื่อนตำแหน่ง</SettingList>
                <SettingLine>
                    <DivInput type='radio' value="" checked/>ให้สิทธิประโยชน์เต็มจำนวน
                    <ButtonSetting>ค่าเริ่มต้น</ButtonSetting>
                </SettingLine>
