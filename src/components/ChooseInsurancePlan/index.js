...
import {Detail, Head, Inner, InnerRight, Submit, Inboxtext,
        inputStyle,  TextInbox,  InnerHead,  InnerHead2,
        AccordionStyle, AccordionStyle2, ManagePlan,
        ImageIcon1, ImageIcon2, EmptyPlan, EmptyPlanText} from './styled'
import {
  Grid,     Image,     Container,
  Divider,  Checkbox,  Segment,
  Icon,     Table,     Accordion,
  Label,    Message
